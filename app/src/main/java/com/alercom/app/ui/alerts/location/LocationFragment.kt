...
class LocationFragment : Fragment(), AdapterView.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.departmentsResult.observe(this@LocationFragment, Observer {
            val eventResult = it ?: return@Observer

            if (eventResult.successList != null) {

                deptAdapter = DeparmentsSpinnerAdapter(Mcontext,eventResult.successList) //{ eventType -> onClickListener(eventType)}
